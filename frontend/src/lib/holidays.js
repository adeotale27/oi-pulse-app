...
const HOLIDAYS_RAW = [
  ...
  { date: "2026-03-17", name: "Id-Ul-Fitr (Ramzan Id)" },
  { date: "2026-03-30", name: "Shri Mahavir Jayanti / Ram Navami" },
  { date: "2026-04-03", name: "Good Friday" },
  { date: "2026-04-14", name: "Dr. Baba Saheb Ambedkar Jayanti" },
  { date: "2026-05-01", name: "Maharashtra Day" },
  { date: "2026-05-27", name: "Buddha Purnima" },
  { date: "2026-08-14", name: "Bakri Id (Id-Ul-Zuha)" },
  { date: "2026-09-15", name: "Ganesh Chaturthi" },
  { date: "2026-10-02", name: "Mahatma Gandhi Jayanti" },
  { date: "2026-10-20", name: "Dussehra" },
  { date: "2026-11-09", name: "Diwali Laxmi Pujan* (Muhurat trading only)" },
