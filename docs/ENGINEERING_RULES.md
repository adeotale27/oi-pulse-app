...
- MCX majors are pollable (nearest FUT + MCX hours) but **not auto-enabled**. Admin **MCX desk** toggle plus Index management Enable. Off → nothing MCX is polled or shown. See [ADR-003](./decisions/ADR-003-mcx-majors.md).
